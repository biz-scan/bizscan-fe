...
export default function SolutionCard({ title, tags }: SolutionCardProps) {
  return (
    <div className="w-full max-w-[1348px] mx-auto rounded-[20px] bg-grey-light shadow-[0_4px_20px_0_rgba(49,49,49,0.08)] px-[clamp(20px,5vw,48px)] py-[30px] flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6">
      ...
      <button className="flex px-[20px] py-[10px] justify-center items-center gap-[10px] border border-grey-normal rounded-[8px] transition-all hover:bg-gray-50 active:scale-95 group">
